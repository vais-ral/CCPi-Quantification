...
try:
    import itk
    itk_version="%d.%d"%(itk.Version.GetITKMajorVersion(), itk.Version.GetITKMinorVersion())
except:
    pass
...
extra_compile_args = []
extra_link_args = []
extra_libraries = ['ITKCommon-'+itk_version,'itkvcl-'+itk_version,'itkvnl-'+itk_version, 'itkvnl_algo-'+itk_version, 'itkv3p_netlib-'+itk_version, 'itksys-'+itk_version, 'ITKStatistics-'+itk_version, 'vtkCommonCore-'+vtk_version,  'vtkImagingCore-'+vtk_version, 'vtkImagingHybrid-'+vtk_version, 'vtkFiltersCore-'+vtk_version, 'vtkCommonComputationalGeometry-'+vtk_version,'vtkCommonDataModel-'+vtk_version,'vtkIOImage-'+vtk_version,'vtkCommonExecutionModel-'+vtk_version, 'vtkCommonMisc-'+vtk_version, 'cilquant']
lip = ''
try:
    ...
    pass
if platform.system() == 'Windows':
    extra_compile_args += ['/TP','/DWIN32','/EHsc','/DCCPiCore_EXPORTS','/Ob2','/O2']
